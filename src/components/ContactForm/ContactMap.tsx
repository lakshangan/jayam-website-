...
const ContactMap = () => {
  return (
    <div className="w-full h-full min-h-[400px] relative rounded-[2rem] overflow-hidden border border-white/5 shadow-2xl group">
      <iframe
      ...
      ></iframe>
      <div className="absolute inset-0 pointer-events-none border-[1px] border-white/10 rounded-[2rem] z-10" />
    </div>
  );
};
