    ...
    <section id="tailoring" className="section-padding bg-background relative overflow-hidden mask-linear-t mask-linear-b">
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <div className="lg:col-span-7 order-2 lg:order-1">
            ...
            <TextReveal delay={0.1}>
              <h2 className="text-4xl md:text-6xl font-bold text-foreground mb-10 leading-[1.1]">
                Master the Art of <span className="gold-gradient-text italic font-normal">Modern Tailoring</span>
              </h2>
            </TextReveal>

            <TextReveal delay={0.2}>
              <div className="space-y-8 mb-16 border-l border-foreground/5 pl-10">
                ...
                <p className="text-foreground/30 text-base leading-relaxed max-w-xl">
          ...
          >
            <div className="relative group p-4">
              <div className="absolute -inset-2 border border-foreground/5 rounded-[2.5rem] rotate-6 group-hover:rotate-0 transition-transform duration-700" />
              ...
              <div className="relative rounded-[2rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] border border-foreground/10 aspect-[4/5] bg-gradient-to-b from-[#0a0a0f] to-[#050508] flex items-center justify-center p-8 group">
                ...
                <div className="absolute inset-4 border border-foreground/5 rounded-[1.5rem] transition-transform duration-700 group-hover:scale-95" />
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                  <div className="relative mb-10">
                    ...
                    <div className="w-24 h-24 md:w-28 md:h-28 rounded-[2rem] bg-gradient-to-br from-accent/20 via-accent/5 to-transparent border border-accent/40 flex items-center justify-center backdrop-blur-md shadow-[0_0_50px_rgba(255,215,0,0.15)] rotate-45 group-hover:rotate-0 transition-all duration-700">
                      <div className="w-14 h-14 md:w-16 md:h-16 rounded-xl border border-accent/30 flex items-center justify-center -rotate-45 group-hover:rotate-0 transition-all duration-700 bg-foreground/20">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-foreground/60 italic text-base md:text-lg font-light">Proud to be an</p>
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm md:text-lg font-medium tracking-[0.3em] md:tracking-[0.4em] text-foreground/70 uppercase pt-2">
                        Training Centre
                      </p>
                    </div>
                  </div>
        ...
        <motion.div
          ...
          className="relative py-16 md:py-24 px-6 md:px-12 rounded-[2.5rem] md:rounded-[4rem] overflow-hidden border border-foreground/5 group"
        >
          <div className="absolute inset-0 bg-foreground/[0.01] backdrop-blur-3xl -z-10" />
            ...
            {accreditationItems.map((item, idx) => (
              <div key={idx} className="h-full flex">
                <TextReveal delay={idx * 0.1} width="100%">
                  <div className="premium-card bg-foreground/[0.02] border-foreground/5 hover:bg-foreground/[0.04] transition-all duration-700 p-6 md:p-8 group/card text-left h-full flex flex-col justify-start items-start">
                    ...
                    <h4 className="text-foreground text-sm md:text-base font-bold uppercase tracking-widest mb-2 md:mb-4">{item.title}</h4>
                    <p className="text-foreground/60 text-xs md:text-sm leading-relaxed font-light mt-auto">{item.content}</p>
                  </div>
                </TextReveal>
              </div>
            ))}
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10 text-[9px] md:text-[10px] uppercase tracking-[0.2em] md:tracking-[0.3em] font-bold text-foreground/10 border-t border-foreground/5 pt-12">
            <div className="flex items-center gap-3">
              <span className="text-foreground/30">Credential:</span>
              <span className="text-foreground/60">JC-NSDC-7742</span>
            </div>
            <div className="w-1 h-1 bg-accent/20 rounded-full hidden md:block" />
            <div className="flex items-center gap-3">
              <span className="text-foreground/30">Accredited Until:</span>
              <span className="text-foreground/60">2026</span>
            </div>
            <div className="w-1 h-1 bg-accent/20 rounded-full hidden md:block" />
            <div className="flex items-center gap-3">
              <span className="text-foreground/30">Authorized By:</span>
