...
const AboutInstitute = () => {
  ...
  return (
    <section id="about" className="relative py-20 bg-gradient-to-b from-pink-50 to-white overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-800 leading-relaxed text-lg font-medium opacity-0 animate-fade-in-delay-4">
