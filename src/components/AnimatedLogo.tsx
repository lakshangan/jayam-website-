...
const AnimatedLogo = () => {
    return (
        <div className="relative w-full h-full min-h-[400px] flex items-center justify-center bg-transparent rounded-[2rem] overflow-hidden group">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 bg-accent/10 rounded-full blur-[100px] pointer-events-none group-hover:bg-accent/20 transition-all duration-1000" />
            ...
            >
                <svg viewBox="0 0 100 100" className="w-full h-full opacity-40">
                    ...
                    <path d="M 50 12 a 38 38 0 0 1 38 38" fill="none" stroke="#c5a358" strokeWidth="1" strokeLinecap="round" className="drop-shadow-[0_0_8px_rgba(197,163,88,0.8)]" />
                </svg>
            </motion.div>
            ...
            <motion.div
                ...
                className="relative z-10 w-56 h-56 md:w-80 md:h-80 rounded-full bg-white/[0.02] backdrop-blur-3xl border border-white/5 flex items-center justify-center shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden"
            >
                ...
                <img
                    ...
                    className="w-[75%] h-[75%] object-contain drop-shadow-[0_0_25px_rgba(255,255,255,0.1)] group-hover:scale-110 group-hover:drop-shadow-[0_0_35px_rgba(197,163,88,0.3)] transition-all duration-700"
                />
            </motion.div>
        </div>
    );
