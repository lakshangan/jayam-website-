      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <div className="flex-shrink-0 lg:w-96">
            <h3 className="text-[11px] uppercase tracking-[0.4em] font-black text-accent/60 mb-10">Contact</h3>
        ...
        <div className="pt-20 border-t border-black/5 flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="flex flex-col items-center md:items-start gap-4">
            <p className="text-[10px] uppercase tracking-[0.5em] text-foreground/30 font-black text-center md:text-left">
            ...
            <div className="flex gap-6 text-[9px] uppercase tracking-widest text-foreground/20 italic font-medium">
              <span className="flex items-center gap-2 mx-auto md:mx-0"><Sparkles size={10} className="text-accent/40" /> Excellence in every stitch</span>
            </div>
          </div>
        </div>
      </div>
